...
public class CustomerDao {
        ...
        public Map<Customer, User> selectAll(){
            ...
            //步骤2：创建出sql语句
            String sql = "select tc.id,tc.cust_name,tc.cust_company,tc.cust_birth,tc.cust_sex,tc.cust_phone,tc.cust_position,tc.create_time,tc.modify_time,tc.user_id from t_user tu,t_customer tc where tu.id=tc.id";
